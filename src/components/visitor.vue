<template>
 <div>
   <div ref="visitorpie" style="width:90%;height:450px"></div>
 </div>
</template>
  ...
  data () {
    return {
      visitor:[
              ...
              {name: '呼尔浩特', value: Math.round(Math.random()*1000)},
    ...
    initData() {
      ...
      const options = {
        ...
        tooltip: {
            trigger: 'item',
            formatter: (params) => {
              return params.name?params.name + ' : ' + params.value[2]:'';
            }
        },
        toolbox: {
          show : true,
        ...
        series: [
          ...
          },
          {
            ...
            data: this.visitor.sort((a,b) => a.value-b.value),
          }
        ]
      }
